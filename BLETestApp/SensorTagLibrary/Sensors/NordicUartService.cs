...
{
    public class NordicUartService : SensorBase
    {
        public NordicUartService()
            : base(SensorName.SimpleKeyService, SensorTagUuid.UUID_NUS_SERV, null, SensorTagUuid.UUID_NUS_TX_DATA)
        {
