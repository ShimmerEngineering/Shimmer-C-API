...
public sealed class ShimmerHardware : IDisposable
{
    private IntPtr _hDevInfo;
    private SP_DEVINFO_DATA _data;

    private ShimmerHardware(IntPtr hDevInfo, SP_DEVINFO_DATA data)
    {
        _hDevInfo = hDevInfo;
        _data = data;
    }

    public static ShimmerHardware Get(string pnpDeviceId)
    {
        if (pnpDeviceId == null)
        ...
        return new ShimmerHardware(hDevInfo, data) { PnpDeviceId = pnpDeviceId };
    }
