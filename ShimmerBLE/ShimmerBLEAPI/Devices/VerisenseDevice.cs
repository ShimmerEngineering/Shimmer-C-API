...
namespace ShimmerBLEAPI.Devices
{
    ...
    public abstract class VerisenseDevice
    {
        ...
        public class DefaultVerisenseConfiguration
        {
            ...
            public static readonly DeviceByteArraySettings Accel1_Default_Setting = new DeviceByteArraySettings("ACCEL 1",new byte[] {0x5A,0x97,0x00,0x00,0x00,0x30,0x30,0x00,0x7F,0x00,0xD8,0x0F,0x09,0x16,0x24,0x0C,0x80,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0xF4,0x00,0x3C,0x00,0x0A,0x0F,0x00,0x00,0x3C,0x00,0x0A,0x0F,0x00,0x00,0x3C,0x00,0x0A,0x0F,0x00,0xFF,0xFF,0xAA,0x01,0x03,0x3C,0x00,0x0E,0x00,0x00,0x63,0x28,0xCC,0xCC,0x1E,0x00,0x0A,0x00,0x00,0x00,0x00,0x01}, "SensorLIS2DW12 - 16G, 25Hz, Using Low Power, Lower Power Mode 1");
            public static readonly DeviceByteArraySettings Accel2_Gyro_Default_Setting = new DeviceByteArraySettings("ACCEL 2 and Gyro", new byte[] {0x5A,0x77,0x00,0x00,0x00,0x30,0x20,0x00,0x7F,0x00,0xD8,0x0F,0x09,0x16,0x24,0x2C,0x80,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0xF4,0x00,0x3C,0x00,0x0A,0x0F,0x00,0x00,0x3C,0x00,0x0A,0x0F,0x00,0x00,0x3C,0x00,0x0A,0x0F,0x00,0xFF,0xFF,0xAA,0x01,0x03,0x3C,0x00,0x0E,0x00,0x00,0x63,0x28,0xCC,0xCC,0x1E,0x00,0x0A,0x00,0x00,0x00,0x00,0x01}, "SensorLSM6DS3 - Accel 16G, Gyro 2000deg/s, 26Hz, Threshold 1");
            public static readonly DeviceByteArraySettings GSR_Batt_Accel1_Default_Setting = new DeviceByteArraySettings("GSR, Battery and Accel 1", new byte[] { 0x5A,0x97,0x80,0x02,0x00,0x30,0x20,0x00,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0xF4,0x00,0x3C,0x00,0x0A,0x0F,0x00,0x00,0x3C,0x00,0x0A,0x0F,0x00,0x00,0x3C,0x00,0x0A,0x0F,0x00,0x17,0x04,0xFF,0xFF,0xFF,0x3C,0x00,0x0E,0x00,0x00,0x63,0x28,0xCC,0xCC,0x1E,0x00,0x0A,0x00,0x00,0x00,0x00,0x01}, "GSR and Battery, 51.2Hz, GSR Auto Range. Accel (SensorLIS2DW12) at 8G, 25Hz, Using Low Power, Lower Power Mode 1");
            public static readonly DeviceByteArraySettings GSR_Batt_Default_Setting = new DeviceByteArraySettings("GSR and Battery", new byte[] { 0x5A, 0x17, 0x80, 0x02, 0x00, 0x30, 0x20, 0x00, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF4, 0x00, 0x3C, 0x00, 0x0A, 0x0F, 0x00, 0x00, 0x3C, 0x00, 0x0A, 0x0F, 0x00, 0x00, 0x3C, 0x00, 0x0A, 0x0F, 0x00, 0x17, 0x04, 0xFF, 0xFF, 0xFF, 0x3C, 0x00, 0x0E, 0x00, 0x00, 0x63, 0x28, 0xCC, 0xCC, 0x1E, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x01 }, "GSR and Battery, 51.2Hz, GSR Auto Range.");
            public static readonly DeviceByteArraySettings PPG_Default_Setting = new DeviceByteArraySettings("PPG", new byte[] { 0x5A, 0x17, 0x74, 0x00, 0x00, 0x00, 0x20, 0x00, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xF4, 0x00, 0x3C, 0x00, 0x0A, 0x0F, 0x00, 0x00, 0x3C, 0x00, 0x0A, 0x0F, 0x00, 0x00, 0x3C, 0x00, 0x0A, 0x0F, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x63, 0x28, 0xCC, 0xCC, 0x1E, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x01 }, "Red Green IR Blue Leds enabled, 50 Hz, Sample Average = 1, Range 4, 420\u00B5s Pulse Width");
