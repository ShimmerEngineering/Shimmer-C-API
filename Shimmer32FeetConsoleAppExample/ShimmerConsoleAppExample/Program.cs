...
namespace ShimmerConsoleAppExample
{
    class Program
    {
        ...
        public void start()
        {
            ...
            shimmer = new ShimmerLogAndStream32Feet("ShimmerID1", "00:06:66:88:db:79", 102.4, 0, ShimmerBluetooth.GSR_RANGE_AUTO, enabledSensors, false, false, false, 1, 0, Shimmer3Configuration.EXG_EMG_CONFIGURATION_CHIP1, Shimmer3Configuration.EXG_EMG_CONFIGURATION_CHIP2, true);
