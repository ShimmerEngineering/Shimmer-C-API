...
namespace ShimmerConsoleAppExample
{
    class Program
    {
        ...
        public void start()
        {
            ...
            shimmer = new ShimmerLogAndStreamSystemSerialPort("ShimmerID1", "COM11", samplingRate, 0, 4, enabledSensors, false, false, false, 0, 0, defaultECGReg1, defaultECGReg2, false);
